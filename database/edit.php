...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE admin_user_accounts SET user_id='$user_id',username='$username',password='$password',role_id='$role_id',emp_ID='$emp_ID',userStatus_ID='$userStatus_ID' WHERE user_id=$user_id";
  $result = mysqli_query($con, $sql);
  if ($result) {
          ...
          <div class="card">
            <div class="row">
              ...
              <div class="auth-form-wrapper px-4 py-5">
                ...
                <h5 class="text-muted fw-normal mb-4">Update User.</h5>
                <form id="signupForm" action="" novalidate="novalidate" method="POST">
                  <div class="mb-3">
                    <label for="name" class="form-label">Username</label>
                    <input type="text" class="form-control" placeholder="Username" name="username" autocomplete="off" value="<?php echo $username ?>">
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Password</label>
                    <input type="text" class="form-control" placeholder="Password" name="password" autocomplete="off" value="<?php echo $password ?>">
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Role ID</label>
                    <select class="form-select" placeholder="Role ID" name="role_id" autocomplete="off" value="<?php echo $role_id ?>" required>
                      <option selected="" disabled="">Select your Role</option>
                      <option value="1">User Admin</option>
                      <option value="2">Document Manager</option>
                      <option value="3">Legal Manager</option>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Employee ID" name="emp_ID" autocomplete="off" value="<?php echo $emp_ID ?>">
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">User Status</label>
                    <select class="form-select" placeholder="User Status" name="userStatus_ID" autocomplete="off" value="<?php echo $userStatus_ID ?>" required>
                  ...
                  <div>
                    ...
                    <button class="btn btn-secondary text-white me-2 mb-2 mb-md-0"><a href="../modules/account-list.php" class="text-light">Back</a></button>
                  </div>
                </form>
              </div>
            </div>
