...
<head>
  ...
  <!-- Layout styles -->
  <link rel="stylesheet" href="../assets/css/legal-management/style.css">
  <!-- End layout styles -->
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="./cases.php" class="nav-link">
              ...
              <span class="link-title">Cases</span>
            </a>
          </li>
          <li class="nav-item">
    ...
    <div class="page-wrapper">
              ...
              <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                  ...
                  <div class="text-center">
                    <p class="tx-16 fw-bolder">LEGAL MANAGEMENT</p>
                    <p class="tx-12 text-muted">legal@lulan.com</p>
                  </div>
                </div>
      ...
      <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">Cases</h4>
          </div>
