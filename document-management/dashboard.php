...
if (isset($_POST['submit'])) {
  ...
  $docu_fileFormat_id = $_POST['docu_fileFormat_id'];
  $docu_categoryID = $_POST['docu_categoryID'];
  $docu_path = $_POST['docu_path'];
  $docu_status = $_POST['docu_status'];

  $sql = "INSERT INTO admin_document_info (docu_id, docu_title, docu_fileFormat_id, docu_categoryID, docu_path, docu_status)
    VALUES ('$docu_id', '$docu_title', '$docu_fileFormat_id', '$docu_categoryID', '$docu_path', '$docu_status')";

  $result = mysqli_query($con, $sql);
  if ($result) {
    // echo "Data Inserted Successfully";
    header('location:../assets/error/document-success.html');
  } else {
...
<head>
  ...
  <!-- Layout styles -->
  <link rel="stylesheet" href="../assets/css/document-management/style.css">
  <!-- End layout styles -->
...
<body>
  <div class="main-wrapper">
    ...
    <nav class="sidebar">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="./document-list.php" class="nav-link">
              <i class="link-icon" data-feather="list"></i>
              <span class="link-title">Document List</span>
            </a>
          </li>
              ...
              <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                  ...
                  <div class="text-center">
                    <p class="tx-16 fw-bolder">DOCUMENT MANAGEMENT</p>
                    <p class="tx-12 text-muted">docu@lulan.com</p>
                  </div>
                </div>
            ...
            <div class="row flex-grow-1">
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card text-white bg-warning">
                  <a href="./archive.php" class="text-light">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-baseline">
        ...
        <div>
          ...
          <div class="row">
            <div class="d-flex align-items-start">
              ...
              <div>
                <h5 class="mb-2" style="text-align:center">Document Send</h5>
                ...
                <div class="row">
                  <div class="col-md-12 stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h6 class="card-title">Send a Document</h6>
                        <form id="signupForm" action="" method="POST">
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="mb-3">
                                <label for="name" class="form-label">Document Title</label>
                                <input type="text" class="form-control" placeholder="Name" name="docu_title" autocomplete="off" required>
                              </div>
                            </div><!-- Col -->
                            <div class="row">
                              <div class="col-sm-4">
                                <div class="mb-3">
                                  <label for="name" class="form-label">File Format</label>
                                  <select class="form-select" placeholder="File Format" name="docu_fileFormat_id" autocomplete="off" required>
                              ...
                              <div class="col-sm-4">
                                <div class="mb-3">
                                  ...
                                  <select class="form-select" placeholder="Category" name="docu_categoryID" autocomplete="off" required>
                              ...
                              <div class="col-sm-4">
                                <div class="mb-3">
                                  ...
                                  <select class="form-select" placeholder="Purpose" name="docu_status" autocomplete="off" required>
                              ...
                              <div class="row">
                                <div class="mb-3">
                                  <label for="file" class="form-label">Path</label>
                                  <input type="file" id="myDropify" class="form-control" placeholder="Reservation Date" name="docu_path" autocomplete="off" required>
                                </div><!-- Col -->
                              </div><!-- Row -->
                              <div class="mb-3">
    ...
    <script>
      ...
      Toast.fire({
        icon: 'success',
        title: 'Welcome DOCUMENT-MANAGEMENT!'
      })
    </script>
