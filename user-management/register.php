...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO admin_user_accounts (username, role_id, emp_ID, userStatus_ID)
    VALUES ('$username', '$role_id', '$emp_ID', '$userStatus_ID')";
                ...
                <div class="auth-form-wrapper px-4 py-5">
                  ...
                  <form id="signupForm" action="" method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="Role ID" name="role_id" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="User Status" name="userStatus_ID" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
