                  ...
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form id="signupForm" action="" novalidate="novalidate" method="POST">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Role ID" name="role_id" autocomplete="off" value="<?php echo $role_id ?>">
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="User Status" name="userStatus_ID" autocomplete="off" value="<?php echo $userStatus_ID ?>">
                      </div>
                      <div>
