    ...
    <div class="page-wrapper">
      ...
      <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">List of Accounts</h4>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <button class="btn btn-primary mb-5"><a href="./register.php" class="text-light">Add User</a></button>
        ...
        <td>' . $status . '</td>
        <td>
        <button class="btn btn-success btn-icon"><a href="./user-view.php?viewid=' . $user_id . '" class="text-light"><i data-feather="eye"></i></a></button>
        <button class="btn btn-primary btn-icon"><a href="./user-edit.php?editid=' . $user_id . '" class="text-light"><i data-feather="edit"></i></a></button>
        <button class="btn btn-danger btn-icon"><a href="./user-delete.php?deleteid=' . $user_id . '" class="text-light"><i data-feather="trash"></i></a></button>
        </td>
    </tr>';
                        }
                      }
