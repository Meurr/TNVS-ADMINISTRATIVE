...
<head>
  ...
  <title>Account List | LULAN</title>
  ...
  <!-- Layout styles -->
  <link rel="stylesheet" href="../assets/css/user-management/style.css">
  <!-- End layout styles -->
      ...
      <div class="page-content">
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <button class="btn btn-primary mb-3"><a href="./register.php" class="text-light">Add User</a></button>
                <div class="table-responsive">
                  <table id="dataTableExample" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT * FROM admin_user_accounts JOIN admin_user_roles ON admin_user_accounts.role_id = admin_user_roles.role_id
                                                                JOIN admin_user_department ON admin_user_accounts.user_dept_ID = admin_user_department.user_dept_ID";
                      ...
                      if ($result) {
                        while ($row = mysqli_fetch_assoc($result)) {
                          ...
                          $emp_ID = $row['emp_ID'];
                          $user_dept_name = $row['user_dept_name'];
        ...
        <td>' . $emp_ID . '</td>
        <td><span class="badge bg-primary">' . $user_dept_name . '</span></td>
        <td>' . $status . '</td>
        <td>
        <button class="btn btn-success btn-icon"><a href="../database/view.php?viewid=' . $user_id . '" class="text-light"><i data-feather="eye"></i></a></button>
        <button class="btn btn-primary btn-icon"><a href="../database/edit.php?editid=' . $user_id . '" class="text-light"><i data-feather="edit"></i></a></button>
        <button class="btn btn-warning btn-icon"><a href="../database/delete.php?deleteid=' . $user_id . '" class="text-light"><i data-feather="archive"></i></a></button>
        </td>
    </tr>';
                        }
                      }
