...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO admin_user_accounts (username, password, role_id, emp_ID, user_dept_ID, userStatus_ID)
    VALUES ('$username','$password', '$role_id', '$emp_ID', '$user_dept_ID', '$userStatus_ID')";
          ...
          <div class="card">
            <div class="row">
              ...
              <div class="auth-form-wrapper px-4 py-5">
                ...
                <h5 class="text-muted fw-normal mb-4">Register New User.</h5>
                <form id="signupForm" action="" method="POST">
                  <div class="mb-3">
                    <label for="name" class="form-label">Username</label>
                    <input type="email" class="form-control" placeholder="Username" name="username" autocomplete="off" required>
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    <label for="text" class="form-label">Role ID</label>
                    <select class="form-select" name="role_id" required>
                      <option value="">Select a Role</option>
                      <?php
                      // Retrieve the list of facilities from the database
                      $query = "SELECT role_id, role_name FROM admin_user_roles";
                  ...
                  <!-- <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Employee ID" name="emp_ID" autocomplete="off" required>
                  </div> -->
                  <div class="mb-3">
                    ...
                    <select class="form-select" name="emp_ID" required>
                      ...
                      <?php
                      // Retrieve the list of facilities from the database
                      $query = "SELECT emp_ID, emp_position FROM admin_employee_info";
                      $result = mysqli_query($con, $query);
                      while ($row = mysqli_fetch_assoc($result)) {
                        // Display each facility as an option in the select element
                        echo "<option value='" . $row['emp_ID'] . "'>" . $row['emp_position'] . "</option>";
                      }
                      ?>
                    </select>
                  </div>
                  <div class="mb-3">
                    ...
                    <select class="form-select" placeholder="Department" name="user_dept_ID" autocomplete="off" required>
                      <option selected="" disabled="">Select Department</option>
                      <option value="1">Logistics</option>
                      <option value="2">Human Resource</option>
                      <option value="3">Core Transaction</option>
                      <option value="4">Administrative</option>
                      <option value="5">Finance</option>
                    </select>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">User Status</label>
                    <select class="form-select" placeholder="User Status" name="userStatus_ID" autocomplete="off" required>
                  ...
                  <div>
                    ...
                    <button class="btn btn-secondary text-white me-2 mb-2 mb-md-0"><a href="./account-list.php" class="text-light">Cancel</a></button>
                  </div>
                </form>
              </div>
            </div>
