...
<head>
  ...
  <title>Document List | LULAN</title>
  ...
  <div class="main-wrapper">
    ...
    <div class="page-wrapper">
                ...
                <div class="table-responsive">
                  <table id="dataTableExample" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT * FROM admin_document_info JOIN admin_document_format ON admin_document_info.docu_fileFormat_id = admin_document_format.docu_fileFormat_id
        JOIN admin_document_category ON admin_document_info.docu_categoryID = admin_document_category.docu_categoryID";
      ...
      <tr>
        ...
        <td>' . $docu_path . '</td>
        <td><span class="badge bg-success">' . $docu_status . '</span></td>
        <td>
          <form method="post" action="../functions/delete-document.php">
            <input type="hidden" name="docu_id" value="' . $docu_id . '">
            <button type="submit" class="btn btn-warning btn-icon-text text-light">
              <i class="btn-icon-prepend" data-feather="archive"></i>Archive
            </button>
          </form>
        </td>
      </tr>
