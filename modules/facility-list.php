...
<head>
    ...
    <title>Facility List | LULAN</title>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <button class="btn btn-primary mb-3"><a href="../functions/add-facilitylist.php" class="text-light">Add Facility</a></button>
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM admin_facility_info JOIN admin_facility_type ON admin_facility_info.facilityType_ID = admin_facility_type.facilityType_ID JOIN admin_facility_status ON admin_facility_info.facilityStatus_ID = admin_facility_status.facilityStatus_ID";
                                            ...
                                            if ($result) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    $facilityType_desc = $row['facilityType_desc'];
                                                    $facilityStatus_desc = $row['facilityStatus_desc'];
                                                    echo
                                                    '<tr>
        <th scope="row">' . $facility_ID . '</th>
        <td>' . $facility_name . '</td>
        <td>' . $facility_desc . '</td>
        <td>' . $facility_capacity . '</td>
        <td><span class="badge bg-primary">' . $facilityType_desc . '</span></td>
        <td><span class="badge bg-primary">' . $facilityStatus_desc . '</span></td>
        <td>
        <button class="btn btn-success btn-icon"><a href="../functions/view-facilitylist.php?viewid=' . $facility_ID . '" class="text-light"><i data-feather="eye"></i></a></button>
        <button class="btn btn-primary btn-icon"><a href="../functions/edit-facilitylist.php?editid=' . $facility_ID . '" class="text-light"><i data-feather="edit"></i></a></button>
        <button class="btn btn-warning btn-icon"><a href="../functions/delete-facilitylist.php?deleteid=' . $facility_ID . '" class="text-light"><i data-feather="archive"></i></a></button>
        </td>
    </tr>';
                                                }
                                            }
