...
<head>
  ...
  <title>Legal Approvals | LULAN</title>
      ...
      <div class="page-content">
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <button class="btn btn-primary mb-3"><a href="../functions/add-legalapproval.php" class="text-light">Add Approval</a></button>
                <div class="table-responsive">
                  <table id="dataTableExample" class="table table-hover">
                    <thead>
                      <tr>
                        <th scope="col">Approval ID</th>
                        <th scope="col">Approval Title</th>
                        <th scope="col">Approval Author</th>
                        <th scope="col">Document ID</th>
                        <th scope="col">Approval Date</th>
                        <th scope="col">Approval Department</th>
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT * FROM admin_legal_approval JOIN admin_document_info ON admin_legal_approval.docu_id = admin_document_info.docu_id
                                                                 JOIN admin_legal_approvalstatus ON admin_legal_approval.approval_status_id = admin_legal_approvalstatus.approval_status_id";
                      ...
                      if ($result) {
                        while ($row = mysqli_fetch_assoc($result)) {
                          ...
                          echo
                          '<tr>
        <th scope="row">' . $approval_id . '</th>
        <td>' . $approval_title . '</td>
        <td>' . $approval_author . '</td>
        <td><span class="badge bg-primary">' . $docu_title . '</span></td>
        <td><span class="badge bg-secondary">' . $approval_date . '</span></td>
        <td>' . $approval_department . '</td>
        <td><span class="badge bg-' . $badge_color . '">' . $approval_status_name . '</span></td>
        </tr>';
                        }
                      }
