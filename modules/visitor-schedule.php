...
<head>
    ...
    <title>Visitor Schedule | LULAN</title>
...
<body>
    <div class="main-wrapper">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                    <div>
                        <nav class="page-breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Visitor Management</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Scheduled Visitor</li>
                            </ol>
                        </nav>
                    </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table id="myTable" class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $sql = "SELECT * FROM admin_visitors_scheduled JOIN admin_visitor_purpose ON admin_visitors_scheduled.vstrPurpose_id = admin_visitor_purpose.vstrPurpose_id";
                                                            $result = mysqli_query($con, $sql);
                                                            if ($result) {
                                                                while ($row = mysqli_fetch_assoc($result)) {
                                                                    $schedVstr_id = $row['schedVstr_id'];
                                                                    $schedVstr_fname = $row['schedVstr_fname'];
                                                                    $schedVstr_lname = $row['schedVstr_lname'];
                                                                    $vstrPurpose_type = $row['vstrPurpose_type'];
                                                                    $schedVstr_timeOfVisit = date('M/d/Y g:i A', strtotime($row['schedVstr_timeOfVisit']));
                                                                    $schedVstr_mobile = $row['schedVstr_mobile'];
                                                                    echo
                                                                    '<tr>
                                                    <th scope="row">' . uniqid($schedVstr_id) . '</th>
        <td>' . $schedVstr_fname . '</td>
        <td>' . $schedVstr_lname . '</td>
        <td><span class="badge bg-primary">' . $vstrPurpose_type . '</span></td>
        <td><span class="badge bg-secondary">' . $schedVstr_timeOfVisit . '</span></td>
        <td>' . $schedVstr_mobile . '</td>
        <td>
        <button class="btn btn-warning btn-icon-text"><a href="../functions/delete-visitorsched.php?deleteid=' . $schedVstr_id . '" class="text-light"><i class="btn-icon-prepend" data-feather="archive"></i>Archive</a></button>
        </td>
    </tr>';
                                                                }
                                                            }
                                                ...
                                                <div class="table-responsive">
                                                    <table id="dataTableExample" class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $sql = "SELECT * FROM archived_visitors_scheduled JOIN admin_visitor_purpose ON archived_visitors_scheduled.vstrPurpose_id = admin_visitor_purpose.vstrPurpose_id";
                                                            $result = mysqli_query($con, $sql);
                                                            if ($result) {
                                                                while ($row = mysqli_fetch_assoc($result)) {
                                                                    $schedVstr_id = $row['schedVstr_id'];
                                                                    ...
                                                                    $schedVstr_timeOfVisit = date('M/d/Y g:i A', strtotime($row['schedVstr_timeOfVisit']));
                                                                    $schedVstr_mobile = $row['schedVstr_mobile'];
                                                                    $schedVstr_status = $row['schedVstr_status'];
                                                                    echo
                                                                    '<tr>
                                                    <th scope="row">' . uniqid($schedVstr_id) . '</th>
        <td>' . $schedVstr_fname . '</td>
        ...
        <td><span class="badge bg-secondary">' . $schedVstr_timeOfVisit . '</span></td>
        <td>' . $schedVstr_mobile . '</td>
        <td><span class="badge bg-warning">' . $schedVstr_status . '</span></td>
    </tr>';
                                                                }
                                                            }
