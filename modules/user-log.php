  ...
  <div class="main-wrapper">
    ...
    <div class="page-wrapper">
      ...
      <div class="page-content">
                ...
                <div class="table-responsive">
                  <table id="dataTableExample" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT * FROM admin_user_session JOIN admin_user_accounts ON admin_user_session.user_id = admin_user_accounts.user_id";
        ...
        <td><span class="badge bg-secondary">' . $session_time . '</span></td>
    </tr>';
                        }
                      }
