...
<head>
    ...
    <title>Visitor List | LULAN</title>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <button class="btn btn-primary mb-3"><a href="../functions/add-visitor.php" class="text-light">Add Visitor</a></button>
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM admin_visitor_info JOIN admin_visitor_purpose ON admin_visitor_info.vstrPurpose_id = admin_visitor_purpose.vstrPurpose_id JOIN admin_visitor_type ON admin_visitor_info.vstr_type_ID = admin_visitor_type.vstr_type_ID";
                                            $result = mysqli_query($con, $sql);
                                            if ($result) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    $vstr_id = $row['vstr_id'];
                                                    $vstr_fname = $row['vstr_fname'];
                                                    $vstr_lname = $row['vstr_lname'];
                                                    $vstrPurpose_type = $row['vstrPurpose_type'];
                                                    $vstr_type_desc = $row['vstr_type_desc'];
                                                    $vstr_mobile = $row['vstr_mobile'];
                                                    echo
                                                    '<tr>
        <th scope="row">' . $vstr_id . '</th>
        <td>' . $vstr_fname . '</td>
        <td>' . $vstr_lname . '</td>
        <td><span class="badge bg-primary">' . $vstrPurpose_type . '</span></td>
        <td><span class="badge bg-primary">' . $vstr_type_desc . '</span></td>
        <td>' . $vstr_mobile . '</td>
        <td>
        <button class="btn btn-success btn-icon"><a href="../functions/view-visitorlist.php?viewid=' . $vstr_id . '" class="text-light"><i data-feather="eye"></i></a></button>
        <button class="btn btn-primary btn-icon"><a href="../functions/edit-visitorlist.php?editid=' . $vstr_id . '" class="text-light"><i data-feather="edit"></i></a></button>
        <button class="btn btn-warning btn-icon"><a href="../functions/delete-visitorlist.php?deleteid=' . $vstr_id . '" class="text-light"><i data-feather="archive"></i></a></button>
        </td>
    </tr>';
                                                }
                                            }
