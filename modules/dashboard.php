  ...
  <div class="main-wrapper">
    ...
    <nav class="sidebar">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="./legal-approvals.php" class="nav-link"><i class="link-icon" data-feather="check-square"></i>
              <span class="link-title">Approvals</span></a>
          </li>
          <li class="nav-item">
            <a href="./legal-cases.php" class="nav-link"><i class="link-icon" data-feather="briefcase"></i>
              <span class="link-title">Cases</span></a>
          </li>
          <li class="nav-item">
            <a href="./legal-contracts.php" class="nav-link"><i class="link-icon" data-feather="book"></i>
              <span class="link-title">Contracts</span></a>
          </li>

          <li class="nav-item nav-category">Document Management</li>
          <li class="nav-item">
            <a href="./document-archive.php" class="nav-link"><i class="link-icon" data-feather="archive"></i>
              <span class="link-title">Archive</span></a>
          </li>
          <li class="nav-item">
            <a href="./document-list.php" class="nav-link"><i class="link-icon" data-feather="file-text"></i>
              <span class="link-title">Document List</span></a>
          </li>

          <li class="nav-item nav-category">Visitor Management</li>
          <li class="nav-item">
            <a href="./visitor-purpose.php" class="nav-link"><i class="link-icon" data-feather="pen-tool"></i>
              <span class="link-title">Purposes</span></a>
          </li>
          <li class="nav-item">
            <a href="./visitor-schedule.php" class="nav-link"><i class="link-icon" data-feather="calendar"></i>
              <span class="link-title">Scheduled Visitor</span></a>
          </li>
          <li class="nav-item">
            <a href="./visitor-list.php" class="nav-link"><i class="link-icon" data-feather="list"></i>
              <span class="link-title">Visitor List</span></a>
          </li>

          <li class="nav-item nav-category">Facility Reservation</li>
          <li class="nav-item">
            <a href="./facility-list.php" class="nav-link"><i class="link-icon" data-feather="book-open"></i>
              <span class="link-title">Facility List</span></a>
          </li>
          <li class="nav-item">
            <a href="./facility-reserve.php" class="nav-link"><i class="link-icon" data-feather="bookmark"></i>
              <span class="link-title">Reserve</span></a>
          </li>

          <li class="nav-item nav-category">User Management</li>
          <li class="nav-item">
            <a href="./account-list.php" class="nav-link"><i class="link-icon" data-feather="users"></i>
              <span class="link-title">Account List</span></a>
          </li>
          <li class="nav-item">
            <a href="./register.php" class="nav-link"><i class="link-icon" data-feather="user-plus"></i>
              <span class="link-title">Register User</span></a>
          </li>
          <li class="nav-item">
            <a href="./user-log.php" class="nav-link"><i class="link-icon" data-feather="user"></i>
              <span class="link-title">User Log</span></a>
          </li>
          <li class="nav-item">
            <a href="./user-roles.php" class="nav-link"><i class="link-icon" data-feather="user-check"></i>
    ...
    <div class="page-wrapper">
      ...
      <div class="page-content">
        ...
        <div>
          <h6 class="mb-3">Legal Management</h6>
        </div>
        <div class="row">
            ...
            <div class="row flex-grow-1">
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card text-light bg-primary">
                  <a href="./legal-cases.php" class="text-light">
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                          ...
                          if ($result = mysqli_query($con, "SELECT case_id FROM admin_legal_case ORDER BY case_id")) {
                            echo "<h3 class='mb-2'>" . mysqli_num_rows($result);
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card text-white bg-primary">
                  <a href="./legal-approvals.php" class="text-light">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-baseline">
                        <h6 class="card-title mb-0">Approvals</h6>
                        <div class="dropdown mb-2">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                          ...
                          if ($result = mysqli_query($con, "SELECT approval_id FROM admin_legal_approval ORDER BY approval_id")) {
                            echo "<h3 class='mb-2'>" . mysqli_num_rows($result);
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card text-white bg-primary">
                  <a href="./legal-contracts.php" class="text-light">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-baseline">
                        <h6 class="card-title mb-0">Contracts</h6>
                        <div class="dropdown mb-2">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                          ...
                          if ($result = mysqli_query($con, "SELECT contracts_id FROM admin_legal_contract ORDER BY contracts_id")) {
                            echo "<h3 class='mb-2'>" . mysqli_num_rows($result);
        ...
        <div>
          <h6 class="mb-3">Document Management</h6>
        </div>
        <div class="row">
          <div class="col-12 col-xl-12 stretch-card">
            <div class="row flex-grow-1">
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card text-light bg-primary">
                  <a href="./document-list.php" class="text-light">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-baseline">
                        <h6 class="card-title mb-0">New Documents</h6>
                        <div class="dropdown mb-2">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                          ...
                          if ($result = mysqli_query($con, "SELECT docu_id FROM admin_document_info ORDER BY docu_id")) {
                            echo "<h3 class='mb-2'>" . mysqli_num_rows($result);
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card text-white bg-warning">
                  <a href="./document-archive.php" class="text-light">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-baseline">
                        <h6 class="card-title mb-0">Archived Documents</h6>
                        <div class="dropdown mb-2">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                          ...
                          if ($result = mysqli_query($con, "SELECT docu_id FROM admin_document_archive ORDER BY docu_id")) {
                            echo "<h3 class='mb-2'>" . mysqli_num_rows($result);
        ...
        <div>
          ...
          <h6 class="mb-3">Visitor Management</h6>
        </div>
        <div class="row">
          <div class="col-12 col-xl-12 stretch-card">
            <div class="row flex-grow-1">
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card text-light bg-primary">
                  <a href="./visitor-schedule.php" class="text-light">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-baseline">
                        <h6 class="card-title mb-0">New Visitor</h6>
                        <div class="dropdown mb-2">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                          ...
                          if ($result = mysqli_query($con, "SELECT vstr_id FROM admin_visitor_info ORDER BY vstr_id")) {
                            echo "<h3 class='mb-2'>" . mysqli_num_rows($result);
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card text-white bg-success">
                  <a href="./visitor-schedule.php" class="text-light">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-baseline">
                        <h6 class="card-title mb-0">Scheduled Visitor</h6>
                        <div class="dropdown mb-2">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                          ...
                          if ($result = mysqli_query($con, "SELECT schedVstr_id FROM admin_visitors_scheduled ORDER BY schedVstr_id")) {
                            echo "<h3 class='mb-2'>" . mysqli_num_rows($result);
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card text-white bg-danger">
                  <a href="./visitor-schedule.php" class="text-light">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-baseline">
                        <h6 class="card-title mb-0">Expired Visitor</h6>
                        <div class="dropdown mb-2">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                          ...
                          if ($result = mysqli_query($con, "SELECT schedVstr_id FROM archived_visitors_scheduled ORDER BY schedVstr_id")) {
                            echo "<h3 class='mb-2'>" . mysqli_num_rows($result);
        ...
        <div>
          <h6 class="mb-3">Facility Reservation</h6>
        </div>
        <div class="row">
          <div class="col-12 col-xl-12 stretch-card">
            <div class="row flex-grow-1">
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card text-white bg-primary">
                  <a href="./facility-list.php" class="text-light">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-baseline">
                        <h6 class="card-title mb-0">New Facility</h6>
                        <div class="dropdown mb-2">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                          ...
                          if ($result = mysqli_query($con, "SELECT facility_ID FROM admin_facility_info ORDER BY facility_ID")) {
                            echo "<h3 class='mb-2'>" . mysqli_num_rows($result);
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                          ...
                          // Fetch active users
                          $sql = "SELECT COUNT(*) AS available_facility FROM admin_facility_info WHERE facilityStatus_ID = 1";
                          $result = mysqli_query($con, $sql);

                          if (mysqli_num_rows($result) > 0) {
                            // Output data of each row
                            while ($row = mysqli_fetch_assoc($result)) {
                              echo "<h3 class='mb-2'>" . $row["available_facility"];
                            }
                          } else {
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                          ...
                          // Fetch active users
                          $sql = "SELECT COUNT(*) AS available_facility FROM admin_facility_info WHERE facilityStatus_ID = 3";
                          $result = mysqli_query($con, $sql);
        ...
        <div class="row">
          <div class="col-12 col-xl-12 stretch-card">
            <div class="row flex-grow-1">
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card text-white bg-primary">
                  <a href="./account-list.php" class="text-light">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-baseline">
                      ...
                      <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                          ...
                          if ($result = mysqli_query($con, "SELECT user_id FROM admin_user_accounts ORDER BY user_id")) {
                            echo "<h3 class='mb-2'>" . mysqli_num_rows($result);
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                          ...
                          // Fetch active users
                          $sql = "SELECT COUNT(*) AS active_users FROM admin_user_accounts WHERE userStatus_ID = 1";
                          $result = mysqli_query($con, $sql);

                          if (mysqli_num_rows($result) > 0) {
                            // Output data of each row
                            while ($row = mysqli_fetch_assoc($result)) {
                              echo "<h3 class='mb-2'>" . $row["active_users"];
                            }
                          } else {
                            echo "No active users found.";
                          }
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-6 col-md-12 col-xl-5">
                          ...
                          // Fetch active users
                          $sql = "SELECT COUNT(*) AS inactive_users FROM admin_user_accounts WHERE userStatus_ID = 2";
                          $result = mysqli_query($con, $sql);

                          if (mysqli_num_rows($result) > 0) {
                            // Output data of each row
                            while ($row = mysqli_fetch_assoc($result)) {
                              echo "<h3 class='mb-2'>" . $row["inactive_users"];
                            }
                          } else {
                            echo "No active users found.";
                          }
