      ...
      <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <nav class="page-breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Legal Management</a></li>
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <button class="btn btn-primary mb-3"><a href="../functions/add-legalcase.php" class="text-light">Generate a Case</a></button>
                  ...
                  <table id="dataTableExample" class="table table-hover">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Case Author</th>
                        <th scope="col">Time Created</th>
                        <th scope="col">Case Path</th>
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT * FROM admin_legal_case JOIN admin_legal_casetype ON admin_legal_case.case_type_id = admin_legal_casetype.case_type_id JOIN admin_legal_casestatus ON admin_legal_case.case_status_id = admin_legal_casestatus.case_status_id";
                      $result = mysqli_query($con, $sql);
                      if ($result) {
                        while ($row = mysqli_fetch_assoc($result)) {
                          $case_id = $row['case_id'];
                          $case_title = $row['case_title'];
                          $case_author = $row['case_author'];
                          $case_timeCreated = $row['case_timeCreated'];
        ...
        <td>' . $case_title . '</td>
        <td>' . $case_author . '</td>
        <td>' . $case_timeCreated . '</td>
        <td>' . $case_path . '</td>
        <td><span class="badge bg-primary">' . $case_type_name . '</span></td>
        <td><span class="badge bg-primary">' . $case_status_name . '</span></td>
    </tr>';
                        }
                      }
