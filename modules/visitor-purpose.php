...
<head>
    ...
    <title>Visitor Purpose | LULAN</title>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <button class="btn btn-primary mb-3"><a href="../functions/add-visitorpurpose.php" class="text-light">Add Purpose</a></button>
                                <div class="table-responsive">
                                    <table id="dataTableExample" class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM admin_visitor_purpose";
                                            $result = mysqli_query($con, $sql);
                                            if ($result) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    $vstrPurpose_id = $row['vstrPurpose_id'];
                                                    $vstrPurpose_type = $row['vstrPurpose_type'];
                                                    echo
                                                    '<tr>
        <th scope="row">' . $vstrPurpose_id . '</th>
