...
<head>
  ...
  <!-- Layout styles -->
  <link rel="stylesheet" href="../assets/css/visitor-management/style.css">
  <!-- End layout styles -->
              ...
              <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                  ...
                  <div class="text-center">
                    ...
                    <p class="tx-12 text-muted">superadmin@lulan.com</p>
                  </div>
                </div>
            ...
            <div class="row flex-grow-1">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                      <h6 class="card-title mb-0">Logistic 1</h6>
                    ...
                    <div class="row">
                      ...
                      <div class="col-6 col-md-12 col-xl-7">
                        <button type="button" class="btn btn-primary btn-lg"><a href="https://logistic-1.lulan-tnvs.com/TNVS/demo1/dashboard.php" target="_blank" class="text-light">Access</a></button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                      <h6 class="card-title mb-0">Logistic 2</h6>
                      <div class="dropdown mb-4">
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-6 col-md-12 col-xl-7">
                        <button type="button" class="btn btn-primary btn-lg"><a href="https://lulan-tnvs.com/TNVS-LOGISTIC2/public/general/dashboard" target="_blank" class="text-light">Access</a></button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                      <h6 class="card-title mb-0">Human Resource 1</h6>
                      <div class="dropdown mb-4">
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-6 col-md-12 col-xl-7">
                        <button type="button" class="btn btn-primary btn-lg"><a href="https://human-resource-1.lulan-tnvs.com/" target="_blank" class="text-light">Access</a></button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                      <h6 class="card-title mb-0">Human Resource 2</h6>
                      <div class="dropdown mb-4">
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-6 col-md-12 col-xl-7">
                        <button type="button" class="btn btn-primary btn-lg"><a href="https://human-resource-2.lulan-tnvs.com/" target="_blank" class="text-light">Access</a></button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                      <h6 class="card-title mb-0">Core 1</h6>
                      <div class="dropdown mb-4">
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-6 col-md-12 col-xl-7">
                        <button type="button" class="btn btn-primary btn-lg"><a href="https://core-1.lulan-tnvs.com/core1/dashboard_admin.php" target="_blank" class="text-light">Access</a></button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                      <h6 class="card-title mb-0">Core 2</h6>
                      <div class="dropdown mb-4">
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-6 col-md-12 col-xl-7">
                        <button type="button" class="btn btn-primary btn-lg"><a href="https://core-2.lulan-tnvs.com/dashboard.php" target="_blank" class="text-light"">Access</a></button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class=" col-md-4 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <div class="d-flex justify-content-between align-items-baseline">
                                  <h6 class="card-title mb-0">Administrative</h6>
                                  <div class="dropdown mb-4">
                                  </div>
                                </div>
                                <div class="row">
                                  ...
                                  <div class="col-6 col-md-12 col-xl-7">
                                    <button type="button" class="btn btn-primary btn-lg"><a href="https://administrative.lulan-tnvs.com/" target="_blank" class="text-light">Access</a></button>
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-6 col-md-12 col-xl-7">
                                <button type="button" class="btn btn-primary btn-lg"><a href="https://finance.lulan-tnvs.com/demo1/dashboard.php" target="_blank" class="text-light">Access</a></button>
                              </div>
                            </div>
                          </div>
                        </div>
