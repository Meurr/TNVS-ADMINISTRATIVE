...
// dito na detalye
$case_author = 'Legal Manager';
$case_title = $_POST['case_title'];
$pdf->Details($case_title, $case_author);

//dito na new page
$pdf->AddPage();

$FB = $_POST['factual-background'];
$FB1 = $_POST['factual-background1'];
$COA = $_POST['legal-grounds'];
$CO = $_POST['criminal-offense'];

$defendant_name = $_POST['defendant-name'];
$defendant_name1 = $_POST['defendant-name1'];
$defendant_position = $_POST['defendant-position'];
$defendant_position1 = $_POST['defendant-position1'];
$cause_of_action = $_POST['cause-of-action'];
$cause_of_crime = $_POST['cause-of-crime'];

$plaintiff_name = $_POST['plaintiff-name'];
$plaintiff_name1 = $_POST['plaintiff-name1'];
$plaintiff_position = $_POST['plaintiff-position'];
$plaintiff_position1 = $_POST['plaintiff-position1'];

$CE = $_POST['crim-evidence'];



$caseType = $_POST['case_type_id'];
if ($caseType == 1) {
    $pdf->ifCivil();
    //CivilBody($case_author, $def_name, $def_pos, $civil_c_o_a, $plain_name, $plain_pos, $fb, $coa)
    $pdf->CivilBody($case_author, $defendant_name, $defendant_position, $cause_of_action, $plaintiff_name, $plaintiff_position, $FB, $COA);
} 
else if ($caseType == 2){
    $pdf->ifCriminal();
    //CriminalBody($case_author, $def_name, $def_pos, $crim_c_o_c, $plain_name, $plain_pos, $fb, $coc, $evidence)
    $pdf->CriminalBody($case_author, $defendant_name1, $defendant_position1, $cause_of_crime, $plaintiff_name1, $plaintiff_position1, $FB1, $CO, $CE );
}


$pdf->Output('I',$case_title.'.pdf',true);
