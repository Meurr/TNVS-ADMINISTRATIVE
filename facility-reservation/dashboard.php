...
if (isset($_POST['submit'])) {
  ...
  if ($rsrv_occupants > $facility_capacity) {
    ...
    if ($result) {
      ...
      header('location:../assets/error/facility-success.html');
    } else {
...
<body>
  <div class="main-wrapper">
	...
	<img src="../assets/images/officepic/1.jpg" class="wd-100 wd-sm-200 me-3" alt="...">
	<div>
    ...
    <button type="button" class="btn btn-primary btn-icon-text"><i class="btn-icon-prepend" data-feather="plus"></i>Add Facility</button>
    </div>
  </div>
</div>
</div>
        ...
        <div class="d-flex align-items-start">
          ...
          <div>
            <h5 class="mb-2" style="text-align:center">Facility Reserve</h5>
  ...
  <script>
    ...
    Toast.fire({
      icon: 'success',
      title: 'Welcome FACILITY-RESERVATION!'
    })
  </script>
