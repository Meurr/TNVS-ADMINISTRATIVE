...
<head>
    ...
    <!-- Layout styles -->
    <link rel="stylesheet" href="../assets/css/facility-reservation/style.css">
    <!-- End layout styles -->
        ...
        <nav class="sidebar">
            ...
            <div class="sidebar-body">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a href="facility-list.php" class="nav-link">
                            <i class="link-icon" data-feather="book-open"></i>
                            <span class="link-title">Facility List</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="facility-reserve.php" class="nav-link">
                            <i class="link-icon" data-feather="bookmark"></i>
                            <span class="link-title">Reserve</span>
                        </a>
                    </li>
        ...
        <div class="page-wrapper">
                            ...
                            <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                                <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                                    ...
                                    <div class="text-center">
                                        <p class="tx-16 fw-bolder">FACILITY RESERVATION</p>
                                        <p class="tx-12 text-muted">facility@lulan.com</p>
                                    </div>
                                </div>
            ...
            <div class="page-content">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                    <div>
                        <h4 class="mb-3 mb-md-0">Reserve</h4>
                    </div>
