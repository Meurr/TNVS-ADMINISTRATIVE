...
if (isset($_POST['submit'])) {
  ...
  if ($result) {
    ...
    header('location:../assets/error/visitor-success.html');
  } else {
...
<body>
              ...
              <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                  ...
                  <div class="text-center">
                    <p class="tx-16 fw-bolder">VISITOR MANAGEMENT</p>
                    <p class="tx-12 text-muted">visitor@lulan.com</p>
                  </div>
                </div>
  ...
  <script>
    ...
    Toast.fire({
      icon: 'success',
      title: 'Welcome VISITOR-MANAGEMENT!'
    })
  </script>
        ...
        $("#signupForm").validate({
          ...
          messages: {
            ...
            schedVstr_mobile: {
              ...
              pattern: "Please enter a valid 11-digit mobile number"
            },
            confirm_password: {
