...
$rsrv_id = $_GET['editid'];
$sql = "SELECT * FROM admin_facility_reservations WHERE rsrv_id=$rsrv_id";
$result = mysqli_query($con, $sql);
$row = mysqli_fetch_assoc($result);

$rsrv_name = $row['rsrv_name'];
$facility_ID = $row['facility_ID'];
$rsrvPurpose_ID = $row['rsrvPurpose_ID'];
$rsrv_date = $row['rsrv_date'];
$rsrv_time = $row['rsrv_time'];
...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE admin_facility_reservations SET rsrv_id='$rsrv_id',rsrv_name='$rsrv_name',facility_ID='$facility_ID',rsrvPurpose_ID='$rsrvPurpose_ID',rsrv_date='$rsrv_date',rsrv_time='$rsrv_time',rsrv_occupants='$rsrv_occupants',rsrv_mobile='$rsrv_mobile' WHERE rsrv_id=$rsrv_id";
  $result = mysqli_query($con, $sql);
  if ($result) {
          ...
          <div class="card">
            <div class="row">
              ...
              <div class="auth-form-wrapper px-4 py-5">
                ...
                <h5 class="text-muted fw-normal mb-4">Update Reservation.</h5>
                <form id="signupForm" action="" novalidate="novalidate" method="POST">
                  <div class="mb-3">
                    <label for="name" class="form-label">Name</label>
                    <input type="text" class="form-control" placeholder="Name" name="rsrv_name" autocomplete="off" value="<?php echo $rsrv_name ?>" required>
                  </div>
                  <div class="mb-3">
                    <label for="text" class="form-label">Facility ID</label>
                    <input class="form-control" name="facility_ID" placeholder="Facility ID" type="text" value="<?php echo $facility_ID ?>" required>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Purpose</label>
                    <select class="form-select" placeholder="Purpose" name="rsrvPurpose_ID" autocomplete="off" value="<?php echo $rsrvPurpose_ID ?>" required>
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input-group date timepicker" id="datetimepickerExample" data-target-input="nearest">
                      <input type="text" class="form-control datetimepicker-input" data-target="#datetimepickerExample" placeholder="Reservation Time" name="rsrv_time" autocomplete="off" required>
                      <span class="input-group-text" data-target="#datetimepickerExample" data-toggle="datetimepicker"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clock">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Occupants" name="rsrv_occupants" autocomplete="off" value="<?php echo $rsrv_occupants ?>" required>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Mobile No.</label>
                    <input type="text" class="form-control" placeholder="Mobile No." name="rsrv_mobile" autocomplete="off" value="<?php echo $rsrv_mobile ?>" required>
                  </div>
                  <div>
                    <button type="submit" class="btn btn-primary text-white me-2 mb-2 mb-md-0" name="submit">Update</button>
                    <button class="btn btn-secondary text-white me-2 mb-2 mb-md-0"><a href="../modules/facility-reserve.php" class="text-light">Back</a></button>
                  </div>
                </form>
              </div>
            </div>
