...
if (isset($_POST['submit'])) {
    ...
    $approval_author = $_POST['approval_author'];
    $docu_id = $_POST['docu_id'];
    $approval_date = $_POST['approval_date'];
    $approval_department = $_POST['approval_department'];
    $approval_status_id = $_POST['approval_status_id'];

    $sql = "INSERT INTO admin_legal_approval (approval_title, approval_author, docu_id, approval_date, approval_department, approval_status_id)
    VALUES ('$approval_title', '$approval_author', '$docu_id', '$approval_date', '$approval_department', '$approval_status_id')";

    $result = mysqli_query($con, $sql);
    if ($result) {
        // echo "Data Inserted Successfully";
        header('location:../modules/legal-approvals.php');
    } else {
                    ...
                    <div class="card">
                        <div class="row">
                            ...
                            <div class="auth-form-wrapper px-4 py-5">
                                ...
                                <h5 class="text-muted fw-normal mb-4">Add Approval.</h5>
                                <form id="signupForm" action="" method="POST">
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Approval Title</label>
                                        <input type="text" class="form-control" placeholder="Approval Title" name="approval_title" autocomplete="off" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Approval Author</label>
                                        <input type="text" class="form-control" placeholder="Approval Author" name="approval_author" autocomplete="off" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" placeholder="Approval Date" name="approval_date" autocomplete="off" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Approval Department</label>
                                        <input type="text" class="form-control" placeholder="Approval Department" name="approval_department" autocomplete="off" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="text" class="form-label">Status</label>
                                        <select class="form-select" name="approval_status_id" required>
                                            <option value="">Select Status</option>
                                            <?php
                                            // Retrieve the list of facilities from the database
                                            $query = "SELECT approval_status_id, approval_status_name FROM admin_legal_approvalstatus";
                                            $result = mysqli_query($con, $query);
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                // Display each facility as an option in the select element
                                                echo "<option value='" . $row['approval_status_id'] . "'>" . $row['approval_status_name'] . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-secondary text-white me-2 mb-2 mb-md-0"><a href="../modules/legal-approvals.php" class="text-light">Cancel</a></button>
                                    </div>
                                </form>
                            </div>
                        </div>
