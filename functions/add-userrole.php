...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO admin_user_roles (role_name)
    VALUES ('$role_name')";

  $result = mysqli_query($con, $sql);
  if ($result) {
    // echo "Data Inserted Successfully";
    header('location:../modules/user-roles.php');
  } else {
            ...
            <div class="card">
              <div class="row">
                ...
                <div class="auth-form-wrapper px-4 py-5">
                  ...
                  <h5 class="text-muted fw-normal mb-4">Add Role.</h5>
                  <form id="signupForm" action="" method="POST">
                    <div class="mb-3">
                      <label for="name" class="form-label">Role Name</label>
                      <input type="text" class="form-control" placeholder="Enter Role Name" name="role_name" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div>
                      ...
                      <button class="btn btn-secondary text-white me-2 mb-2 mb-md-0"><a href="../modules/user-roles.php" class="text-light">Cancel</a></button>
                    </div>
                  </form>
                </div>
              </div>
