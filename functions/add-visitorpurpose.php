...
if (isset($_POST['submit'])) {
  $vstrPurpose_type = $_POST['vstrPurpose_type'];

  $sql = "INSERT INTO admin_user_roles (vstrPurpose_type)
    VALUES ('$vstrPurpose_type')";

  $result = mysqli_query($con, $sql);
  if ($result) {
    // echo "Data Inserted Successfully";
    header('location:../modules/visitor-purpose.php');
  } else {
            ...
            <div class="card">
              <div class="row">
                ...
                <div class="auth-form-wrapper px-4 py-5">
                  ...
                  <h5 class="text-muted fw-normal mb-4">Add Purpose Type.</h5>
                  <form id="signupForm" action="" method="POST">
                    <div class="mb-3">
                      <label for="name" class="form-label">Purpose Type</label>
                      <input type="text" class="form-control" placeholder="Enter Purpose Type" name="vstrPurpose_type" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div>
                      ...
                      <button class="btn btn-secondary text-white me-2 mb-2 mb-md-0"><a href="../modules/visitor-purpose.php" class="text-light">Cancel</a></button>
                    </div>
                  </form>
                </div>
              </div>
