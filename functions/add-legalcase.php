...
if (isset($_POST['submit'])) {
    ...
    $case_author = $_POST['case_author'];
    $case_timeCreated = $_POST['case_timeCreated'];
    $case_path = $_POST['case_path'];
    $case_type_id = $_POST['case_type_id'];
    $case_status_id = $_POST['case_status_id'];

    $sql = "INSERT INTO admin_legal_case (case_title, case_author, case_timeCreated, case_path, case_type_id, case_status_id)
    VALUES ('$case_title', '$case_author', '$case_timeCreated', '$case_path', '$case_type_id', '$case_status_id')";

    $result = mysqli_query($con, $sql);
    if ($result) {
        // echo "Data Inserted Successfully";
        header('location:../modules/legal-cases.php');
    } else {
...
<body>
                    ...
                    <div class="card">
                        <div class="row">
                            ...
                            <div class="auth-form-wrapper px-4 py-5">
                                ...
                                <h5 class="text-muted fw-normal mb-4">Generate a Case.</h5>
                                <form id="signupForm" method="POST" action='../create/generate/generate.php'>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label for="pdf_title" class="form-label">Title:</label>
                                                <input id="pdf_title" class="form-control" name="case_title" type="text" required />
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label for="pdf_author" class="form-label">Author:</label>
                                                <input disabled id="pdf_author" class="form-control" name="case_author" type="text" placeholder="Legal Manager" required />
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label for="pdf_subject" class="form-label">Subject: </label>
                                                <input disabled id="pdf_subject" class="form-control" name="pdf_subject" type="text" placeholder="Complaint" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <div class="form-check form-check-inline">
                                                    <input id="civil-case" type="radio" class="form-check-input" name="case_type_id" value="1" />
                                                    <label for="civil-case" class="form-check-label">Civil Case</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <div class="form-check form-check-inline">
                                                    <input id="criminal-case" type="radio" class="form-check-input" name="case_type_id" value="2" />
                                                    <label for="criminal-case" class="form-check-label">Criminal Case</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                <label for="pdf_orientation" class="form-label">File Orientation</label>
                                                <select id="pdf_orientation" class="form-select" name="pdf_orientation">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                <label for="pdf_size" class="form-label">File Size</label>
                                                <select id="pdf_size" class="form-select" name="pdf_size">
                                    ...
                                    <div id="civil-case-fields" class="hidden">
                                        <h6 class="card-title">Case Details for Civil</h6>
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="defendant-name" class="form-label">Defendant Name </label>
                                                    <input id="defendant-name" class="form-control" name="defendant-name" type="text" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="defendant-position" class="form-label">Nature of business </label>
                                                    <input id="defendant-position" class="form-control" name="defendant-position" type="text" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="cause-of-action" class="form-label">Cause of Action </label>
                                                    <input id="cause-of-action" class="form-control" name="cause-of-action" type="text" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="plaintiff-name" class="form-label">Plaintiff Name </label>
                                                    <input id="plaintiff-name" class="form-control" name="plaintiff-name" type="text" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="plaintiff-position" class="form-label">Nature of business </label>
                                                    <input id="plaintiff-position" class="form-control" name="plaintiff-position" type="text" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="factual-background" class="form-label">Factual Background</label>
                                                    <textarea id="factual-background" class="form-control" name="factual-background" rows="3" cols="30" placeholder="State the facts that support the cause of action. Be concise and specific."></textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="legal-grounds" class="form-label">Cause of Action</label>
                                                    <textarea id="legal-grounds" class="form-control" name="legal-grounds" rows="3" cols="30" placeholder="State the legal grounds for the cause of action. Be concise and specific."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="criminal-case-fields" class="hidden">
                                        <h6 class="card-title">Case Details for Criminal</h6>
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="defendant-name1" class="form-label">Defendant Name </label>
                                                    <input id="defendant-name1" class="form-control" name="defendant-name1" type="text" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="defendant-position1" class="form-label">Nature of business </label>
                                                    <input id="defendant-position1" class="form-control" name="defendant-position1" type="text" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="cause-of-crime" class="form-label">Cause of Action </label>
                                                    <input id="cause-of-crime" class="form-control" name="cause-of-crime" type="text" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="plaintiff-name1" class="form-label">Plaintiff Name </label>
                                                    <input id="plaintiff-name1" class="form-control" name="plaintiff-name1" type="text" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="plaintiff-position1" class="form-label">Nature of business </label>
                                                    <input id="plaintiff-position1" class="form-control" name="plaintiff-position1" type="text" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="factual-background1" class="form-label">Factual Background</label>
                                                    <textarea id="factual-background1" class="form-control" name="factual-background1" rows="3" cols="30" placeholder="State the facts that support the cause of action. Be concise and specific."></textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="criminal-offense" class="form-label">Criminal Offense</label>
                                                    <textarea id="criminal-offense" class="form-control" name="criminal-offense" rows="3" cols="30" placeholder="State the legal grounds for the cause of action. Be concise and specific."></textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label for="crim-evidence" class="form-label">Evidence</label>
                                                    <textarea id="crim-evidence" class="form-control" name="crim-evidence" rows="3" cols="30" placeholder="Provide the evidence that supports the criminal offense committed by the Defendant. This may include documents, videos, or other supporting material."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <label for="termsCheck" class="form-check-label">
                                                I confirm that I read and agree to the <a href="#" data-bs-toggle="modal" data-bs-target="#TOS">Terms of Service</a>
                                            </label>
                                            <input id="termsCheck" type="checkbox" name="terms_agree" class="form-check-input" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <label for="termsCheck" class="form-check-label">
                                                I confirm that I read and agree to the <a href="#" data-bs-toggle="modal" data-bs-target="#PP">Privacy Policy</a>
                                            </label>
                                            <input id="termsCheck" type="checkbox" name="terms_agree1" class="form-check-input" />
                                        </div>
                                    </div>

                                    <div>
                                        <button type="submit" class="btn btn-primary submit" value="Generate PDF" name="submit">Generate</button>
                                        <button class="btn btn-secondary text-white me-2 mb-2 mb-md-0"><a href="../modules/legal-cases.php" class="text-light">Back</a></button>
                                    </div>
                                </form>
                            </div>
                        </div>
            ...
            $(function() {
                ...
                $("#signupForm").validate({
                    ...
                    messages: {
                        ...
                        terms_agree1: "Please agree to Privacy Policy"
                    },
    ...
    <script>
        const civilFields = document.getElementById('civil-case-fields');
        const criminalFields = document.getElementById('criminal-case-fields');
        const civilCaseRadio = document.getElementById('civil-case');
        const criminalCaseRadio = document.getElementById('criminal-case');

        civilCaseRadio.addEventListener('change', () => {
            civilFields.classList.remove('hidden');
            criminalFields.classList.add('hidden');
        });

        criminalCaseRadio.addEventListener('change', () => {
            criminalFields.classList.remove('hidden');
            civilFields.classList.add('hidden');
        });
    </script>
