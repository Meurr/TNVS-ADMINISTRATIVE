    ...
    <div class="page-wrapper">
      ...
      <div class="page-content">
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">Visitor Info.</h4>
          </div>
              ...
              <div class="auth-form-wrapper px-4 py-5">
                <form id="signupForm" action="" novalidate="novalidate" method="POST">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="First Name" name="vstr_fname" autocomplete="off" value="<?php echo $vstr_fname ?>" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Last Name</label>
                    <input type="text" class="form-control" placeholder="Last Name" name="vstr_lname" autocomplete="off" value="<?php echo $vstr_lname ?>" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Purpose</label>
                    <input class="form-control" placeholder="Purpose" name="vstrPurpose_id" autocomplete="off" value="<?php echo $vstrPurpose_id ?>" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Type</label>
                    <input class="form-control" placeholder="Type" name="vstr_type_ID" autocomplete="off" value="<?php echo $vstr_type_ID ?>" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Mobile No.</label>
                    <input type="text" class="form-control" placeholder="Mobile No." name="vstr_mobile" autocomplete="off" value="<?php echo $vstr_mobile ?>" readonly>
                  </div>
                  <div>
