    ...
    <div class="page-wrapper">
      ...
      <div class="page-content">
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">Facility List.</h4>
          </div>
              ...
              <div class="auth-form-wrapper px-4 py-5">
                <form id="signupForm" action="" novalidate="novalidate" method="POST">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Name" name="facility_name" autocomplete="off" value="<?php echo $facility_name ?>" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="text" class="form-label">Description</label>
                    <input class="form-control" name="facility_desc" placeholder="Description" type="text" value="<?php echo $facility_desc ?>" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="text" class="form-label">Capacity</label>
                    <input class="form-control" name="facility_capacity" placeholder="Capacity" value="<?php echo $facility_capacity ?>" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="text" class="form-label">Facility Type</label>
                    <input type="text" class="form-control" placeholder="Facility Type" name="facilityType_ID" autocomplete="off" value="<?php echo $facilityType_ID ?>" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Facility Status</label>
                    <input type="text" class="form-control" placeholder="Facility Status" name="facilityStatus_ID" autocomplete="off" value="<?php echo $facilityStatus_ID ?>" readonly>
                  </div>
                  <div>
