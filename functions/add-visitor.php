...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO admin_visitor_info (vstr_fname, vstr_lname, vstrPurpose_id, vstr_type_ID, vstr_mobile)
    VALUES ('$vstr_fname', '$vstr_lname', '$vstrPurpose_id', '$vstr_type_ID', '$vstr_mobile')";
          ...
          <div class="card">
            <div class="row">
              ...
              <div class="auth-form-wrapper px-4 py-5">
                ...
                <h5 class="text-muted fw-normal mb-4">Register Visitor.</h5>
                <form id="signupForm" action="" method="POST">
                  <div class="mb-3">
                    <label for="name" class="form-label">First Name</label>
                    <input type="text" class="form-control" placeholder="Enter First Name" name="vstr_fname" autocomplete="off" required>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Last Name</label>
                    <input type="text" class="form-control" placeholder="Enter Last Name" name="vstr_lname" autocomplete="off" required>
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <select class="form-select" placeholder="Type" name="vstr_type_ID" autocomplete="off" required>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" placeholder="Mobile No." name="vstr_mobile" autocomplete="off" required>
                  </div>
                  <div class="mb-3">
                  ...
                  <div>
                    ...
                    <button class="btn btn-secondary text-white me-2 mb-2 mb-md-0"><a href="../modules/visitor-list.php" class="text-light">Cancel</a></button>
                  </div>
                </form>
              </div>
            </div>
