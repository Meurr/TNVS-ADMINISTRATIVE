...
$facility_ID = $_GET['editid'];
$sql = "SELECT * FROM admin_facility_info WHERE facility_ID=$facility_ID";
...
$facilityType_ID = $row['facilityType_ID'];
$facilityStatus_ID = $row['facilityStatus_ID'];
...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE admin_facility_info SET facility_ID='$facility_ID',facility_name='$facility_name',facility_desc='$facility_desc',facility_capacity='$facility_capacity',facilityType_ID='$facilityType_ID',facilityStatus_ID='$facilityStatus_ID' WHERE facility_ID=$facility_ID";
  $result = mysqli_query($con, $sql);
  if ($result) {
          ...
          <div class="card">
            <div class="row">
              ...
              <div class="auth-form-wrapper px-4 py-5">
                ...
                <h5 class="text-muted fw-normal mb-4">Update Facility.</h5>
                <form id="signupForm" action="" novalidate="novalidate" method="POST">
                  <div class="mb-3">
                    <label for="name" class="form-label">Facility Name</label>
                    <input type="text" class="form-control" placeholder="Facility Name" name="facility_name" autocomplete="off" value="<?php echo $facility_name ?>" required>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Facility Description</label>
                    <input type="text" class="form-control" placeholder="Facility Description" name="facility_desc" autocomplete="off" value="<?php echo $facility_desc ?>" required>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Capacity</label>
                    <input type="number" class="form-control" placeholder="Capacity" name="facility_capacity" autocomplete="off" value="<?php echo $facility_capacity ?>" required>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Type</label>
                    <select class="form-select" placeholder="Type" name="facilityType_ID" autocomplete="off" value="<?php echo $facilityType_ID ?>" required>
                      <option selected="" disabled="">Select Type</option>
                      <option value="1">Open for Reservation</option>
                      <option value="2">Facility use only</option>
                    </select>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Status</label>
                    <select class="form-select" placeholder="Status" name="facilityStatus_ID" autocomplete="off" value="<?php echo $facilityStatus_ID ?>" required>
                      <option selected="" disabled="">Select Type</option>
                      <option value="1">Available</option>
                      <option value="2">Reserved</option>
                      <option value="3">Occured</option>
                    </select>
                  </div>
                  <div>
                    <button type="submit" class="btn btn-primary text-white me-2 mb-2 mb-md-0" name="submit">Update</button>
                    <button class="btn btn-secondary text-white me-2 mb-2 mb-md-0"><a href="../modules/facility-list.php" class="text-light">Back</a></button>
                  </div>
                </form>
              </div>
            </div>
