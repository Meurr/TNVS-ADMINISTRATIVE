    ...
    <div class="page-wrapper">
      ...
      <div class="page-content">
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">Reservation Info.</h4>
          </div>
              ...
              <div class="auth-form-wrapper px-4 py-5">
                <form id="signupForm" action="" novalidate="novalidate" method="POST">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Name" name="rsrv_name" autocomplete="off" value="<?php echo $rsrv_name ?>" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="text" class="form-label">Facility ID</label>
                    <input class="form-control" name="facility_ID" placeholder="Facility ID" type="text" value="<?php echo $facility_ID ?>" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="text" class="form-label">Purpose</label>
                    <input class="form-control" name="rsrvPurpose_ID" placeholder="Purpose" value="<?php echo $rsrvPurpose_ID ?>" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="date" class="form-label">Date</label>
                    <input type="date" class="form-control" placeholder="Reservation Date" name="rsrv_date" autocomplete="off" value="<?php echo $rsrv_date ?>" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="time" class="form-label">Time</label>
                    <input type="text" class="form-control" placeholder="Reservation Time" name="rsrv_time" autocomplete="off" value="<?php echo $rsrv_time ?>" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="occupants" class="form-label">Occupants</label>
                    <input type="text" class="form-control" placeholder="Occupants" name="rsrv_occupants" autocomplete="off" value="<?php echo $rsrv_occupants ?>" readonly>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Mobile No.</label>
                    <input type="text" class="form-control" placeholder="Mobile No." name="rsrv_mobile" autocomplete="off" value="<?php echo $rsrv_mobile ?>" readonly>
                  </div>
                  <div>
