...
$vstr_id = $_GET['editid'];
$sql = "SELECT * FROM admin_visitor_info WHERE vstr_id=$vstr_id";
...
$vstr_type_ID = $row['vstr_type_ID'];
$vstr_mobile = $row['vstr_mobile'];

if (isset($_POST['submit'])) {
  $vstr_fname = $_POST['vstr_fname'];
  $vstr_lname = $_POST['vstr_lname'];
  $vstrPurpose_id = $_POST['vstrPurpose_id'];
  $vstr_type_ID = $_POST['vstr_type_ID'];
  $vstr_mobile = $_POST['vstr_mobile'];

  $sql = "UPDATE admin_visitor_info SET vstr_id='$vstr_id',vstr_fname='$vstr_fname',vstr_lname='$vstr_lname',vstrPurpose_id='$vstrPurpose_id',vstr_type_ID='$vstr_type_ID',vstr_mobile='$vstr_mobile' WHERE vstr_id=$vstr_id";
  $result = mysqli_query($con, $sql);
  if ($result) {
    ...
    <div class="page-wrapper">
      ...
      <div class="page-content">
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">Update Visitor.</h4>
          </div>
          ...
          <div class="card">
            <div class="row">
              ...
              <div class="auth-form-wrapper px-4 py-5">
                ...
                <h5 class="text-muted fw-normal mb-4">Update Visitor.</h5>
                <form id="signupForm" action="" novalidate="novalidate" method="POST">
                  <div class="mb-3">
                    <label for="name" class="form-label">First Name</label>
                    <input type="text" class="form-control" placeholder="First Name" name="vstr_fname" autocomplete="off" value="<?php echo $vstr_fname ?>" required>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Last Name</label>
                    <input type="text" class="form-control" placeholder="Last Name" name="vstr_lname" autocomplete="off" value="<?php echo $vstr_lname ?>" required>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Purpose</label>
                    <select class="form-select" placeholder="Purpose" name="vstrPurpose_id" autocomplete="off" value="<?php echo $vstrPurpose_id ?>" required>
                  ...
                  <div class="mb-3">
                    ...
                    <select class="form-select" placeholder="Type" name="vstr_type_ID" autocomplete="off" value="<?php echo $vstr_type_ID ?>" required>
                      <option selected="" disabled="">Select Type</option>
                      <option value="1">Visit</option>
                      <option value="2">Applicant</option>
                      <option value="3">Guest</option>
                      <option value="4">VIP</option>
                      <option value="5">Stockholder</option>
                    </select>
                  </div>
                  <div class="mb-3">
                    <label for="name" class="form-label">Mobile No.</label>
                    <input type="text" class="form-control" placeholder="Mobile No." name="vstr_mobile" autocomplete="off" value="<?php echo $vstr_mobile ?>" required>
                  </div>
                  <div>
                    <button type="submit" class="btn btn-primary text-white me-2 mb-2 mb-md-0" name="submit">Update</button>
                    <button class="btn btn-secondary text-white me-2 mb-2 mb-md-0"><a href="../modules/visitor-list.php" class="text-light">Back</a></button>
                  </div>
                </form>
              </div>
            </div>
